...
System umożliwia zarządzanie wieloma obiektami jednocześnie, bez żadnych ograniczeń geograficznych. Oprogramowanie funkcjonuje w chmurze danych i jest udostępnione w modelu **SaaS**. Użytkownik sam decyduje, jaki zakres obsługi wybiera i jak długo będzie z niej korzystał.
